...
import { Users, Search, Phone, ChevronRight, Loader2, Calendar, Building2 } from "lucide-react"
          ...
          <div className="bg-[hsl(220_25%_9%)] border border-white/6 rounded-2xl p-12 flex flex-col items-center gap-4 text-center">
            ...
            <div>
              ...
              <p className="text-white/40 text-sm mt-1.5 max-w-xs mx-auto">
                You don't have any assigned members yet. Join a gym and ask the owner to assign members to you.
              </p>
            </div>
