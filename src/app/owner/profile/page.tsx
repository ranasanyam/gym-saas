        ...
        <div className="flex flex-col items-center justify-center">
            <label className="relative cursor-pointer group shrink-0">
              ...
              {profile?.avatarUrl ? (
                ...
                <div className="w-32 h-32 rounded-full bg-gradient-primary flex items-center justify-center text-white font-bold text-xl">
                  {initials}
                </div>
              )}
            ...
            <div className="flex flex-row gap-1 items-center mt-2 mb-2 text-xs text-primary py-1 px-2 bg-orange-500/10 rounded-full border border-primary">
            ...
            <div className="flex flex-row gap-5 mt-2 mb-2 border-t border-white/10 pt-2">
                <div className="flex items-center gap-1">
                    <MapPinIcon className="w-4 h-4 text-white/30" />
                    <p className="text-white/30 text-xs">{profile?.city}</p>
                </div>
                <div className="flex items-center gap-1">
                    <Phone className="w-4 h-4 text-white/30" />
                    <p className="text-white/30 text-xs">{profile?.mobileNumber}</p>
                </div>
            </div>
        </div>

      </div>
      <div className="bg-[hsl(220_25%_9%)] border border-white/6 rounded-2xl p-7 space-y-6 mt-2">
