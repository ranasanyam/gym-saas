...
import { useProfile } from "@/contexts/ProfileContext"
import { useToast } from "@/hooks/use-toast"
import { User, Lock, Save, Loader2, Eye, EyeOff, Camera } from "lucide-react"
import { Input } from "@/components/ui/input"
import { Label } from "@/components/ui/label"
import { Button } from "@/components/ui/button"
...
export default function MemberProfilePage() {
  ...
  // Upload avatar image then immediately save to profile
    ...
    <div className="max-w-xl space-y-5">
      ...
      <div className="bg-[hsl(220_25%_9%)] border border-white/6 rounded-2xl p-6 flex items-center gap-5">
        ...
        <div>
          ...
          <span className="inline-block mt-1 text-xs bg-blue-500/15 text-blue-400 px-3 py-1 rounded-full">Member</span>
        </div>
      </div>
