...
//       subtitle="Join GymStack and manage your gym smarter"
//     >
//       <form onSubmit={handleSubmit} className="space-y-4">

//         {/* Full name */}
//         <div className="space-y-1.5">
//           <Label htmlFor="fullName" className="text-white/65 text-sm">
...
//           <div className="space-y-1.5">
//             <Label htmlFor="mobile" className="text-white/65 text-sm">
...
//           </div>
//           <div className="space-y-1.5">
//             <Label htmlFor="city" className="text-white/65 text-sm">
...
//           >
//             <SelectTrigger className="bg-white/5 border-white/10 text-white h-11 focus:ring-0 focus:border-primary data-placeholder:text-white/25">
...
//             Have a referral code? Enter it to give your referrer a reward.
//           </p>
//         </div>
