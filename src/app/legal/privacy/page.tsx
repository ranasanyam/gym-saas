  ...
  return (
    <article className="prose-legal">
      ...
      <ul>
        ...
        <li><strong style={{ color: "#fff" }}>Gym and business data</strong> — gym name, address, operating hours, membership plans, locker assignments, expense records, and financial records.</li>
        <li><strong style={{ color: "#fff" }}>Health &amp; fitness data</strong> — attendance logs, membership history, workout plans, diet plans, daily workout logs, meal logs, and body metrics (weight, body fat %, BMI, muscle mass, chest/waist/hip measurements).</li>
        <li><strong style={{ color: "#fff" }}>AI plan data</strong> — when you generate an AI workout or diet plan, your fitness goals, current metrics, and preferences are sent to Google Gemini AI to produce personalised recommendations. This data is processed by Google under their data processing terms.</li>
        ...
        <li><strong style={{ color: "#fff" }}>Device &amp; notification data</strong> — push notification tokens (Expo) and device metadata used to deliver in-app and push notifications to the mobile app.</li>
        <li><strong style={{ color: "#fff" }}>Usage data</strong> — screens visited, and feature interactions and error logs to improve the product.</li>
      </ul>

      <h2>2. How We Use Your Information</h2>
      <ul>
        <li>Provide, operate, and improve the GymStack platform and mobile app.</li>
        <li>Generate personalised AI workout and diet plans using Google Gemini AI.</li>
        <li>Send push notifications and in-app alerts (plan assignments, payment receipts, supplement purchase requests, announcements).</li>
        <li>Send transactional emails (welcome, OTP verification, password reset, receipts).</li>
      ...
      <ul>
        <li><strong style={{ color: "#fff" }}>Service providers</strong> — Razorpay (payments), Resend (email delivery), Vercel (hosting), Supabase/PostgreSQL (database), Expo (push notifications), and Google Gemini AI (AI plan generation). Each is bound by a data processing agreement.</li>
        <li><strong style={{ color: "#fff" }}>Your gym</strong> — your trainer and gym owner can view your fitness data, attendance, plan history as part of the gym management service.</li>
      ...
      <p>We retain your personal data for as long as your account is active or as needed to provide services. You may request deletion of your account at any time by contacting <a href="mailto:privacy@gymstack.co.in">privacy@gymstack.co.in</a>. Payment records may be retained longer to meet accounting and legal requirements.</p>

      <h2>5. Security</h2>
      <p>We implement industry-standard measures to protect your data, including TLS encryption in transit, bcrypt-hashed passwords, JWT-based mobile authentication with short-lived access tokens stored in device secure storage (Expo SecureStore / Android Keystore), and access controls. No system is 100% secure — please use a strong, unique password and notify us immediately of any suspected unauthorized access.</p>
      ...
      <p>To exercise any of these rights, contact us at <a href="mailto:privacy@gymstack.co.in">privacy@gymstack.co.in</a>.</p>
      ...
      <h2>10. Contact</h2>
      <p>Questions or concerns about this policy? Reach us at <a href="mailto:privacy@gymstack.co.in">privacy@gymstack.co.in</a> or visit our <a href="/legal/contact">Contact page</a>.</p>
    </article>
  )
}
